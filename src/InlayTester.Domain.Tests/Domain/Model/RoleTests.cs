...
public class RoleTests
{
    ...
    public void MachineOperator()
    {
        ...
        Check.That(role.ToString())
            .IsEqualTo("Role { Id = 1b59a2f7236847b3a0977643d514eddf, Name = operator }");
    }
    ...
    public void MachineSetter()
    {
        ...
        Check.That(role.IsAdministrator).IsFalse();
        Check.That(role.ToString())
            .IsEqualTo("Role { Id = 2a6ddeb3537147758df72598f8c8c8cf, Name = setter }");
    }
    ...
    public void Administrator()
    {
        ...
        Check.That(role.ToString())
            .IsEqualTo("Role { Id = 3b38b2d8bf9949a9b96ddb69ed378d50, Name = administrator }");
    }
}
